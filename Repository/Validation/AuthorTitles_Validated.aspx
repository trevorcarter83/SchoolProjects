<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuthorTitles_Validated.aspx.cs" Inherits="DataControls_AuthorTitles" %>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Price" SortExpression="price">
                        <EditItemTemplate>
                            ...
                            <asp:RangeValidator ID="vldPrice" runat="server" ErrorMessage="Price must be greater than 0." Type="Double" MinimumValue="0.01" ControlToValidate="TextBox2" />
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Advance" SortExpression="advance">
                        <EditItemTemplate>
                            ...
                            <asp:RangeValidator ID="vldAdvance" runat="server" ErrorMessage="Advance must be greater than 0." Type="Double" MinimumValue="0.01" ControlToValidate="TextBox3" />
                        </EditItemTemplate>
                        <ItemTemplate>
...
<%--                    <asp:RangeValidator ID="vldRoyalty" runat="server" ErrorMessage="Royalty must be greater than 0." Type="Integer"  MinimumValue="1" ControlToValidate="TextBox3" />--%>
