<%@ Page Language="C#" AutoEventWireup="true" CodeFile="oldReportError.aspx.cs" Inherits="ReportError" MaintainScrollPositionOnPostback="true" %>
                                ...
                                <div id="customer_details" class="col1-set">
                                            ...
                                            <div class="clear"></div>
                                             ...
                                             <p id="contact_email_field" class="form-row form-row-first validate-required validate-email">
                                                <label class="" for="EmailAddress">Email Address <abbr title="required" class="required">*</abbr>
                                                </label>
