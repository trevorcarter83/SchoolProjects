...
<?php
	...
	if(isset($_POST['submit']))
	{
		...
		$SptoApprove = $_POST['SptoApprove'];



		$statement = $dbconnect->prepare("UPDATE PaidTimeOffForm SET SupervisorSignature = :ptoSupervisorSignature, SupervisorSignatureDate = :ptoSupervisorDate, SupervisorApproved = :SptoApprove WHERE PaidTimeOffFormID =".$form_ID);
		...
		$statement->bindParam(':SptoApprove', $SptoApprove);
...
<head>
    ...
    <link href="../forms.css" rel="stylesheet">
	<title>Supervisor Review Change of Position</title>
<!-- Bootstrap core CSS -->
...
<div class="portrait">
	<form method="POST" action="SupervisorReviewPersonalLeavePayout.php?ID=<?php echo $form_ID ?>">
		...
		<div style="width: 45%;" class="lfloat bottomborder">
			<input type="text" name="ptoSupervisorSignature" style="width: 200px;">
		</div>
		<div style="width: 15%;" class="lfloat">
			&nbsp;
		</div>
		<div style="width: 20%;" class="lfloat bottomborder text-center">
			<input type="text" name="ptoSupervisorDate" style="width: 150px;">
		</div>
		<div style="width: 45%;" class="clearfloat-left">
